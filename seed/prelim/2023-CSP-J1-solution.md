...
**考点与权重：** struct-basic: 80%, sequence-structure: 20%
...
**考点与权重：** linked-list: 70%, language-basics: 21%, struct-basic: 9%
...
**考点与权重：** tree-theory: 70%, mathematics: 19%, combinatorics: 11%
...
**考点与权重：** combinatorics: 70%, permutation-combination: 19%, enumeration: 11%
...
**考点与权重：** high-precision: 70%, basic-algorithms: 20%, mathematics: 10%
...
**考点与权重：** stack: 70%, sequence-structure: 19%, simulation: 11%
...
**考点与权重：** huffman-tree: 70%, base-conversion: 21%, greedy: 9%
...
**考点与权重：** stl: 70%, mathematics: 17%, language-basics: 13%
...
**考点与权重：** mathematics: 70%, sequence-structure: 19%, stl: 11%
...
**考点与权重：** language-basics: 70%, stl: 17%, conditional-branch: 13%
...
**考点与权重：** mathematics: 70%, stl: 19%, language-basics: 11%
...
**考点与权重：** dynamic-programming: 70%, string-basic: 18%, array-basic: 12%
...
**考点与权重：** dynamic-programming: 70%, string-basic: 20%, ad-hoc: 10%
...
**考点与权重：** array-basic: 70%, dynamic-programming: 19%, conditional-branch: 11%
...
**考点与权重：** string-basic: 70%, dynamic-programming: 19%, language-basics: 11%
...
**考点与权重：** enumeration: 70%, loop-structure: 16%, function-recursion-basic: 14%
...
**考点与权重：** conditional-branch: 70%, enumeration: 30%
...
**考点与权重：** primality-test: 70%, enumeration: 19%, mathematics: 11%
...
**考点与权重：** enumeration: 70%, mathematics: 19%, primality-test: 11%
...
**考点与权重：** mathematics: 70%, function-recursion-basic: 16%, enumeration: 14%
...
**考点与权重：** binary-search: 70%, array-basic: 19%, mathematics: 11%
...
**考点与权重：** binary-search: 70%, array-basic: 18%, mathematics: 12%
...
**考点与权重：** array-basic: 70%, conditional-branch: 16%, binary-search: 14%
