...
- 你好小轻：面向学生的编程学习助教；默认使用讯飞星辰，后台可全局切换 DeepSeek V4 Flash、控制思考模式，并在 DeepSeek 认证、余额、限流或服务故障时单向降级到讯飞。支持独立审查模型、生成中断标记、每用户 5MB 历史上限以及用户/管理员用量统计。
...
- `POST /api/ai/sessions/batch-delete`
